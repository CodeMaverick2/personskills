...
for cd use github self host action runner 
...
$ Invoke-WebRequest -Uri https://github.com/actions/runner/releases/download/v2.331.0/actions-runner-win-x64-2.331.0.zip -OutFile actions-runner-win-x64-2.331.0.zip# Optional: Validate the hash
$ if((Get-FileHash -Path actions-runner-win-x64-2.331.0.zip -Algorithm SHA256).Hash.ToUpper() -ne '473e74b86cd826e073f1c1f2c004d3fb9e6c9665d0d51710a23e5084a601c78a'.ToUpper()){ throw 'Computed checksum did not match' }# Extract the installer
...
$ ./config.cmd --url https://github.com/CodeMaverick2/personskills --token BB262EUE5E7BQJY66SH3KYDJNSN5I# Run it!
$ ./run.cmd
